...
#ifndef __CorePuzzle16_include_CorePuzzle16_h__
#define __CorePuzzle16_include_CorePuzzle16_h__

//This is a umbrella header indented to ease the inclusion of all files
//needed to use the Puzzle16 Game Core.
...
#endif // defined(__CorePuzzle16_include_CorePuzzle16_h__) //
